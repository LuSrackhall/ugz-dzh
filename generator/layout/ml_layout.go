...
func DefaultMLSpec() MLSpec {
	return MLSpec{
		...
		ColHeaderRowCount: 1,
		DataRowsPerPage:   20,
tttBackColProportions: []MLColProportion{
tttt{Name: "日期", Ratio: 8},
tttt{Name: "凭证号", Ratio: 7},
tttt{Name: "摘要", Ratio: 15},
tttt{Name: "借方金额", Ratio: 10},
tttt{Name: "贷方金额", Ratio: 10},
tttt{Name: "方向", Ratio: 4},
tttt{Name: "余额", Ratio: 10},
tttt{Name: "明细1", Ratio: 9},
tttt{Name: "明细2", Ratio: 9},
tttt{Name: "明细3", Ratio: 9},
tttt{Name: "明细4", Ratio: 9},
ttt},
tttFrontColProportions: []MLColProportion{
tttt{Name: "明细5", Ratio: 10},
tttt{Name: "明细6", Ratio: 10},
tttt{Name: "明细7", Ratio: 10},
tttt{Name: "明细8", Ratio: 10},
tttt{Name: "明细9", Ratio: 10},
tttt{Name: "明细10", Ratio: 10},
tttt{Name: "明细11", Ratio: 10},
tttt{Name: "明细12", Ratio: 10},
tttt{Name: "明细13", Ratio: 10},
tttt{Name: "明细14", Ratio: 10},
ttt},
	}
}
